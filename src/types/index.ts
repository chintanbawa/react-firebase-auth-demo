...
//Types
export type TAuthActons =
  | { type: 'SET_REFRESH_TOKEN'; refreshToken: string; isAuthenticated: boolean }
  | { type: 'SAVE_FIREBASE_USER'; firebaseUser: User };
...
export type TAuthContext = {
  ...
  saveFirebaseUser: (user: User) => void;
  logout: () => void;
};
